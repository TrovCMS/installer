...
class PushToGitHubTest extends TestCase
{
    ...
    /** @test */
    public function it_pushes_to_github()
    {
    ...
    /** @test */
    public function it_logs_a_warning_if_branch_name_cannot_be_determined()
    {
    ...
    /** @test */
    public function it_logs_a_warning_if_pushing_to_git_hub_fails()
    {
        $this->consoleWriter = $this->mock(ConsoleWriter::class);
    ...
    /** @test */
    public function it_skips_pushing_to_github()
    {
