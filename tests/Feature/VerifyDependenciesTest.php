...
class VerifyDependenciesTest extends TestCase
{
    ...
    /** @test */
    public function it_throws_a_lambo_exception_if_composer_is_missing()
    {
    ...
    /** @test */
    public function it_throws_a_lambo_exception_if_valet_is_missing()
    {
    ...
    /** @test */
    public function it_throws_a_lambo_exception_if_git_is_missing()
    {
