...
class EditConfigFileTest extends TestCase
{
    ...
    /** @test */
    public function it_creates_the_config_directory_and_file_then_opens_the_file_for_editing()
    {
        $when = $and = $then = $this;
    ...
    /** @test */
    public function it_creates_a_config_file_then_opens_the_file_for_editing()
    {
    ...
    /** @test */
    public function it_opens_a_config_file_for_editing()
    {
        $this->configDirectoryExists();
    ...
    /** @test */
    public function it_throws_an_exception_if_the_configured_editor_fails_to_open()
    {
        $this->configDirectoryExists();
        $this->configFileExists();
    ...
    /** @test */
    public function failing_to_create_the_configuration_directory_throws_an_exception()
    {
