...
class CommandLineConfigurationTest extends TestCase
{
    ...
    /** @test */
    public function it_gets_a_command_line_configuration_value()
    {
    ...
    /** @test */
    public function it_returns_null_if_a_command_line_configuration_value_is_missing()
    {
        $this->withoutCommandLineArguments();
    ...
    /** @test */
    public function it_returns_null_if_a_command_line_configuration_value_is_empty()
    {
        $this->withoutCommandLineArguments();
