...
class SavedConfigurationTest extends TestCase
{
    ...
    /** @test */
    public function it_gets_a_saved_configuration_value()
    {
    ...
    /** @test */
    public function it_returns_null_if_a_saved_configuration_option_is_missing()
    {
        $savedConfiguration = new SavedConfiguration([
    ...
    /** @test */
    public function it_returns_null_if_a_saved_configuration_option_has_no_value()
    {
        $savedConfiguration = new SavedConfiguration([
    ...
    /** @test */
    public function it_returns_null_if_a_saved_configuration_option_is_empty()
    {
        $savedConfiguration = new SavedConfiguration([
    ...
    /** test */
    public function it_returns_null_when_the_configuration_file_does_not_exist()
    {
    ...
    /** @test */
    public function it_returns_null_if_a_non_existent_property_is_requested()
    {
        $savedConfiguration = new SavedConfiguration([]);
    ...
    /** @test */
    public function it_casts_strings_to_booleans()
    {
        $savedConfiguration = new SavedConfiguration([
