...
class SetConfigTest extends TestCase
{
    ...
    /** @test */
    public function it_throws_a_LamboException_if_valet_config_is_missing()
    {
        File::shouldReceive('isFile')
            ->with(config('home_dir').'/.config/valet/config.json')
            ->once()
     ...
     */
    public function it_sets_the_breeze_starter_kit_configuration()
    {
        $this->withValetTld('test-domain');
     ...
     * @group front-end-scaffolding
     */
    public function it_sets_the_jetstream_starter_kit_configuration()
    {
        $this->withValetTld('test-domain');
     ...
     * @group front-end-scaffolding
     */
    public function it_ensures_only_one_starter_kit_is_configured()
    {
        $this->withValetTld('test-domain');
     ...
     * @group front-end-scaffolding
     */
    public function it_asks_for_clarification_when_breeze_configuration_is_invalid()
    {
        $this->withValetTld('test-domain');
     ...
     * @group front-end-scaffolding
     */
    public function it_asks_for_clarification_when_jetstream_configuration_is_invalid()
    {
        $this->withValetTld('test-domain');
